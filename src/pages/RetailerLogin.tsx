  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Redirecting to retailer dashboard.",
      });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-amber-100 to-amber-50">
      <Card className="w-full max-w-md border-amber-300">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-amber-800">Retailer Login</CardTitle>
          <CardDescription>Log in to view gold rates and place bookings</CardDescription>
        </CardHeader>
        <CardContent>
